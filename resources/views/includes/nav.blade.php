<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="{{route('home')}}" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('storage/images/logo2.png') }}" class="h-12 dark:hidden" alt="Letstrade Logo" />
            <img src="{{ asset('storage/images/logo2-dark.png') }}" class="h-12 hidden dark:block"
                alt="LetsTrade Dark Mode Logo" />
                ...
                @auth
                    <li>
                        <form action="{{ route('auth.logout') }}" method="post">
                            ...
                            @method('POST')
                            <button type="submit"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Logout</button>
                        </form>
                    </li>
                @endauth
            </ul>
