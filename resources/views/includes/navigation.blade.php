                ...
                <div navbar-menu
                    ...
                    @auth
                        <button id="dropdownUserAvatarButton">
                            <img class="w-12 rounded-full" src="{{ asset('storage/' . $user->image) }}" alt="user photo" />
                        </button>
                        ...
                        <div id="dropdownAvatar"
                            ...
                            <div class="py-2">
                                <form action="{{ route('auth.logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left block px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign
                                        out</button>
                                </form>
                            </div>
                        </div>
