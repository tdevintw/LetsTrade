                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 my-4">
                                <h2 class="h4 mb-1">SubCategories Management</h2>
                                <p class="mb-3">here you can manage the platform's subcategories</p>
                                <div style="margin-bottom: 10px">
                                    <a href="{{route('subcategories.create')}}"><button type="button" class="btn btn-success">New SubCategory</button></a>
                                </div>
